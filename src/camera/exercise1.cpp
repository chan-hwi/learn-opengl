...
glm::vec3 cameraDirection = cameraPos - targetPos;
...
int main()
{
    Window windowObj = Window(800, 600, "Texture Practice");
    ...
    Shader shader("shaders/coordinate-system/vertex.glsl", "shaders/coordinate-system/fragment.glsl");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 view = glm::lookAt(cameraPos, cameraPos + cameraDirection, glm::vec3(0.0f, 1.0f, 0.0f));
        view = glm::translate(view, glm::vec3(0.0f, 0.0f, -3.0f));

        glm::mat4 projection = glm::mat4(1.0f);
        projection = glm::perspective(glm::radians(fov),
                                      (float)windowObj.width / (float)windowObj.height,
                                      0.1f, 100.0f);
...
void processInput(GLFWwindow *window)
{
    ...
    glm::vec3 forwardDirection = glm::normalize(glm::vec3(cameraDirection.x, 0.0f, cameraDirection.z));
    glm::vec3 rightDirection = glm::normalize(glm::cross(forwardDirection, glm::vec3(0.0f, 1.0f, 0.0f)));

    if (glfwGetKey(window, GLFW_KEY_W) == GLFW_PRESS)
    {
        cameraPos += forwardDirection * 0.05f;
    }
    ...
    {
        cameraPos -= rightDirection * 0.05f;
    }
